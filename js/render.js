...
function Renderer( id, texture, skin ) {
	...
	if (this.skin == null) {
		playerTexture.image.src = "media/skins/player.png";
	} else {
		playerTexture.image.src = this.skin;
	}
	try {
	...
	if (this.texture == null) {
		terrainTexture.image.src = "media/textures/terrain.png";
	} else {
		terrainTexture.image.src = this.texture;
	}
	try {
...
Renderer.prototype.loadPlayerHeadModel = function() {
	...
	var vertices = [
		...
		0.25, -0.25, 0.25, 8/64, 8/32, 1, 1, 1, 1, 
		0.25, -0.25, -0.25, 8/64, 16/32, 1, 1, 1, 1, 
		0.25, 0.25, -0.25, 0/64, 16/32, 1, 1, 1, 1, 
		0.25, 0.25, -0.25, 0/64, 16/32, 1, 1, 1, 1, 
